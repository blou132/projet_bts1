            ...
            <?php if (!empty($currentUser)): ?>
              <td class="table-actions">
                <details>
                  ...
                  <form method="post" action="?route=calendrier&action=updateResult" data-ajax="results">
                  ...
                  <form method="post" action="?route=calendrier&action=deleteResult" data-ajax="results" onsubmit="return confirm('Supprimer ce resultat ?');">
                    <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrfToken) ?>">
                    <input type="hidden" name="result_id" value="<?= (int)$row['result_id'] ?>">

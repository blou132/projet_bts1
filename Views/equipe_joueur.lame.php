    ...
    <tbody>
      <?php foreach ($rows as $r): ?>
        <tr>
          ...
          <td><?php if ($r['blason']): ?><img src="<?= htmlspecialchars(asset_path($r['blason'])) ?>" class="thumb" alt="logo écurie"><?php endif; ?></td>
          <td><?= htmlspecialchars($r['prenom'] . ' ' . $r['nom']) ?></td>
          <td><?= htmlspecialchars($r['poste']) ?></td>
          <td><?php if ($r['photo']): ?><img src="<?= htmlspecialchars(asset_path($r['photo'])) ?>" class="thumb" alt="portrait pilote"><?php endif; ?></td>
        </tr>
      <?php endforeach; ?>
    </tbody>
  </table>

<section>
  ...
  <?php if (!empty($isAdmin)): ?>
    <form method="post" enctype="multipart/form-data" action="/championnats/store">
      <fieldset>
    ...
    <tbody>
      <?php foreach ($championnats as $c): ?>
        <tr>
          ...
          <td>
            <?php if ($c['blason']): ?>
              <img src="<?= htmlspecialchars(asset_path($c['blason'])) ?>" alt="affiche du Grand Prix" class="thumb">
            <?php endif; ?>
          </td>
          <?php if (!empty($isAdmin)): ?>
          <td class="table-actions">
            <details>
              ...
              <form method="post" enctype="multipart/form-data" action="/championnats/update">
            ...
            <form method="post" action="/championnats/delete" onsubmit="return confirm('Supprimer ce Grand Prix&nbsp;?')">
              <input type="hidden" name="id" value="<?= $c['id'] ?>">
              <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrfToken) ?>">
